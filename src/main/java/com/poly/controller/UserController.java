...
import com.poly.service.impl.UserServiceEmpl;
...
public class UserController extends HttpServlet{
	...
	private UserService userService = new UserServiceEmpl();
	...
	private void doGetForgotPass(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// TODO Auto-generated method stub
		RequestDispatcher rd = req.getRequestDispatcher("/views/user/forgot-password.jsp");
		rd.forward(req, resp);
	}
